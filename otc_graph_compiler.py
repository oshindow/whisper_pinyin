...
class OtcTrainingGraphCompiler(object):
    def __init__(
        ...
        self.token_table = k2.SymbolTable.from_file(lang_dir / "tokens_otc.txt")
    ...
    def texts_to_ids(self, texts: List[str]) -> List[List[int]]:
        ...
        return [self.token_table[text] for text in texts]
