...
class WhisperModelModule(LightningModule):
    ...
    def validation_step(self, batch, batch_id):
        ...
        for u, o, l in zip(uids, out, labels):
            ...
            o_list = [item for item in normlizer(o.text)]
            l_list = [item for item in self.tokenizer.decode(l, skip_special_tokens=True)]
            cer_results.append((u, l_list, o_list))

        cer = error_stats(test_set_name="val", results=cer_results, compute_CER=True, sclite_mode=False, enable_log=False)
