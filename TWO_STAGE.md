...
- wav2vec2-style latent SpecAugment during training (`time_prob=0.65`,
  `time_length=10`, `feature_prob=0.25`, `feature_length=64`);
...
`/data2/xintong/checkpoints/whisper_pinyin_ctc_medium_actual_twostage_specaug/`.
