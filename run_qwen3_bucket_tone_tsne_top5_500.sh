...
OUTPUT_DIR="${OUTPUT_DIR:-results/qwen3_finalbucket_step29007/tone_tsne_l2_top5_finals_500_per_tone}"
...
exec "$PYTHON_BIN" scripts/analyze_qwen3_tone_latents.py \
  ...
  --num-finals 5 --samples-per-tone 500 --candidate-multiplier 2 \
