...
def load_model(
    ...
    with (
        ...
        if name not in _MODELS:
            ...
            # for large-v1 model
            # checkpoint["dims"] = {'n_mels': 80, 'n_vocab': 51865, 'n_audio_ctx': 1500, 'n_audio_state': 1280, 'n_audio_head': 20, 'n_audio_layer': 32, 'n_text_ctx': 448, 'n_text_state': 1280, 'n_text_head': 20, 'n_text_layer': 32}
            
            # for large model
            # checkpoint["dims"] = {'n_mels': 128, 'n_vocab': 51866, 'n_audio_ctx': 1500, 'n_audio_state': 1280, 'n_audio_head': 20, 'n_audio_layer': 32, 'n_text_ctx': 448, 'n_text_state': 1280, 'n_text_head': 20, 'n_text_layer': 32}
            checkpoint["model_state_dict"] = OrderedDict()
            for key, values in checkpoint["state_dict"].items():
                if 'spk_grl' in key:
                    print('skip spk_grl', key)
                    continue
